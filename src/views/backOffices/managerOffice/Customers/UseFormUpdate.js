...
const UseFormUpdate = ({preloadedValues,onSubmit}) => {
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="form-row">
                    <div className="form-group col-md-6">
                        ...
                        <input type="date" className="form-control"  style={errors.birthday?inputBorderErrorsStyle:null} {...register("birthday") } />
